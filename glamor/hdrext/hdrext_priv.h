...
extern DevPrivateKeyRec HdrColorMapPrivateKeyRec;
#define HdrColorMapPrivateKey (&HdrColorMapPrivateKeyRec)
 ...
 */
typedef enum {
    HDR_impl_passthough = 0,         /* do nothing */
    HDR_impl_tf_linear,              /*  0..10000 nits */
    HDR_impl_tf_linear_norm_bt2020,  /*  [0..1], where 1 - 10000 nits */
    HDR_impl_tf_pq,
    HDR_impl_tf_gamma,
    HDR_impl_tf_COUNT,
} HDR_impl_tf;
...
typedef enum {
    HDR_colorspace_passthough,
    HDR_colorspace_BT2020,
    HDR_colorspace_custom, /* defined by points */
    HDR_colorspace_COUNT
} HDR_colorspace;
...
/**
 * Holds default parameters for color maps
 */
typedef struct {
    HDR_impl_tf tf;
    HDR_colorspace colorspace;
...
typedef struct {
    ...
    GLuint BT2020_linearnorm_to_linear;
    GLuint BT2020_pq_to_linear;

    glamor_program SDR8bit_to_BT2020_linear_glamor;
    glamor_program BT2020_linear_to_crt_PQ_glamor;
    glamor_program BT2020_linearnorm_to_linear_glamor;
    glamor_program BT2020_pq_to_linear_glamor;
