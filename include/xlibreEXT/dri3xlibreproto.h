...
typedef struct {
  CARD32 length;                     /** record length in 4 bytes units including strings and uuids **/
  ...
  /* EXT_device_persistent_id - in theory worth, but at the time of writing this only in very recent drivers implemented */
